...
class Formation
{
     ...
     *
     * @param \AppBundle\Entity\Formation $employeeFormation
     *
     * @return Formation
     */
    public function addEmployeeFormation(\AppBundle\Entity\Formation $employeeFormation)
    {
     ...
     */
    public function removeEmployeeFormation(\AppBundle\Entity\Formation $employeeFormation)
    {
